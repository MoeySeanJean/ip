...
public class ParserTest {
    ...
    public void parseTest() {
        ...
        assertEquals(new AddCommand(new String[]{"deadline", "test", "/by", "2025-08-22"}), new Parser().parse("deadline test /by 2025-08-22"));
        assertEquals(new AddCommand(new String[]{"event", "test", "/from", "2025-08-22", "/to", "2025-08-22"}), new Parser().parse("event test /from 2025-08-22 /to 2025-08-22"));
